...
/**
 * VoiceChecker — the interactive textarea + highlighted preview + score
 * panel for /voice-check. Extracted from page.tsx so the page shell
 * (header, headline copy, footer) stays server-rendered.
 *
